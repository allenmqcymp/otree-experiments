...
SECRET_KEY = '=+24wc6zl&ahb67a-!j!3n9xz!n1$usldtni9ip7w=b_r96fq('
...
SESSION_CONFIGS = [
    ...
    {
        'name': 'my_prisoners_dilemma',
        'display_name': "My version of prisoner's dilemma",
        'num_demo_participants': 2,
        'app_sequence': [
            'my_prisoners_dilemma',
        ],

    },
    {
        'name': 'market_wage',
        'display_name': 'Experiment: Rigidity of wages and effort through market cycles',
        'num_demo_participants': 2,
        'app_sequence': [
            'market_wage',
        ],
        # 'number_subperiods': 12,
        # 'number_periods': 4,
        'base_revenue': 1000,
        'base_multiplier': 1.0,
        'recession_multiplier': 0.9,
        'boom_multiplier': 1.2,
    },
]
