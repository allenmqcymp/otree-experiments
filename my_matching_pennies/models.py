...
author = 'Allen ma from otree docs'

doc = """
Matching pennies project copied from matching pennies project on otree docs
"""
#
#
...
#             self.sessions.vars['paying_round'] = paying_round
...
#             if self.round_number == self.session.vars['paying__round'] and player.is_winner:
